...
if (isset($_POST['uname']) && isset($_POST['password'])
    && isset($_POST['name']) && isset($_POST['re_password']) && isset($_POST['vname']) && isset($_POST['vnumber']) && isset($_POST['vmodel'])) {
	...
	if (empty($uname)) {
        ...
        header("Location: signup.php?error=Model is required&$user_data");
	    exit();
	}
